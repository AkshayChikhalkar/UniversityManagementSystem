...
\section{System architecture}
	...
	\begin{table}[ht]
		...
		\begin{tabular}{|c|Sc|}
			\hline
			Mains Powered Device               & \cincludegraphics[width=1cm]{Images/mains-powered-device.png} \\ \hline
			Period Energy Limited Device       & \cincludegraphics[width=1cm]{Images/period-energy-limited-device.png} \\ \hline
			Always-On Device                   & \cincludegraphics[width=1cm]{Images/always-on-device.png} \\ \hline
			Normally-Sleeping Device           & \cincludegraphics[width=1cm]{Images/normally-sleeping-device.png} \\ \hline
			Rules Engine                       & \cincludegraphics[width=1cm]{Images/rules-engine.png} \\ \hline
			Event-Based Sensing                & \cincludegraphics[width=1cm]{Images/event-based-sensing.png} \\ \hline
			Schedule-Based Sensing             & \cincludegraphics[width=1cm]{Images/schedule-based-sensing.png} \\ \hline
			Device Gateway					   & \cincludegraphics[width=1cm]{Images/device-gateway.png} \\ \hline
		\end{tabular}
